...
export const IdeaCard: React.FC<Record<string, unknown>> = () => {
          ...
          <section>
            <div className="content">
              ...
              <aside>
                ...
                <p>
                  Hi, I'm Riccardo Cavallo and I'm a Graphic and Visual
                  Designer.
                </p>
              </aside>
            ...
            <div className={isExpanded ? 'title active' : 'title'}>
              <p>Contact Me</p>
            </div>
          </section>
        </main>
        <nav className={isExpanded ? 'active' : ''}>
